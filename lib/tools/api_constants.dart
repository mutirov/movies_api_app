class ApiConstants {
  ...
  // TV Series URLs
  static String popularTvUrl = '$baseTvUrl/popular?api_key=$apiKey&language=en-US&page=1';
  static String topRatedTvUrl = '$baseTvUrl/top_rated?api_key=$apiKey&language=en-US&page=1';
  static String airingTodayTvUrl = '$baseTvUrl/airing_today?api_key=$apiKey&language=en-US&page=1';
  static String onTheAirTvUrl = '$baseTvUrl/on_the_air?api_key=$apiKey&language=en-US&page=1';
}
